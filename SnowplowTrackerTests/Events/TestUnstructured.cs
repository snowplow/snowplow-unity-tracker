...
namespace SnowplowTrackerTests.Events {
	...
	public class TestUnstructured {
		...
		public void TestInitMinimal () {
			...
			Assert.AreEqual ("{\"data\":{\"data\":{\"demo\":\"app\"}, \"schema\":\"iglu:acme.com/demo/jsonschema/1-0-0\"}, \"schema\":\"iglu:com.snowplowanalytics.snowplow/unstruct_event/jsonschema/1-0-0\"}", payload [Constants.UNSTRUCTURED]);
		}
